package com.kingirbah.makasihudahsehat.view.history
...
import com.kingirbah.makasihudahsehat.R
import com.kingirbah.makasihudahsehat.model.ModelDatabase
import com.kingirbah.makasihudahsehat.utils.FunctionHelper.rupiahFormat
...
class RiwayatAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvKategori.text = "Pelayanan " + data.jenisSampah
        holder.tvBerat.text = "Usia : " + data.berat.toString() + " Tahun"
        holder.tvSaldo.text = "Tagihan : " + rupiahFormat(data.harga)
