package com.kingirbah.makasihudahsehat.view.main
...
import com.kingirbah.makasihudahsehat.Login
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setInitLayout()
        setCurrentLocation()
        hasil = findViewById(R.id.outputUser)
    ...
    private fun setInitLayout() {
        ...
        cvKategori.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, dokter::class.java)
            startActivity(intent)
        }
