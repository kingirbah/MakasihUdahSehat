package com.kingirbah.makasihudahsehat.view.input
...
import com.kingirbah.makasihudahsehat.viewmodel.InputDataViewModel
...
class InputDataActivity : AppCompatActivity() {
    ...
    private fun setInitLayout() {
        strKategori = resources.getStringArray(R.array.Jenis_Pelayanan)
